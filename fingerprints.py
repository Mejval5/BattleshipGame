...
class ParseFingerPrint:
    ...
    def is_valid(self):
        ...
        for i in range(len(self.tokens)):
            if type(self.tokens[i]) != type(self.parsed_message.tokens[i]):
                return False
        return True
...
class NickParseFingerPrint(ParseFingerPrint):
    ...
    def __init__(self, parsed_message):
        self.command = parsed_message._children[0].value
    ...
    def get_salt(self):
        return self.parsed_message._children[2]

    def get_nick(self):
        return self.parsed_message._children[1]
...
class PutShipParseFingerPrint(ParseFingerPrint):
    ...
    def get_size(self):
        return self.parsed_message._children[3]
    
    def is_vertical(self):
        return self.parsed_message._children[4]
